...
urlpatterns = [
    ...
    path('api/mobile/report-cards/', include('report_card.api_urls')),
    ...
    path('institute/report-card-grade-rules/', include('report_card.admin_urls')),
    path('institute/', include('institute_admin.urls')),
    path('teacher/report-cards/', include('report_card.urls')),
    path('student/report-cards/', include('report_card.student_urls')),
