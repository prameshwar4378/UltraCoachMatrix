...
PRIVATE_MEDIA_ACCEL_REDIRECT_PREFIX = os.environ.get("PRIVATE_MEDIA_ACCEL_REDIRECT_PREFIX", "")
...
BACKGROUND_JOB_ASYNC_NOTIFICATIONS = os.environ.get(
    "BACKGROUND_JOB_ASYNC_NOTIFICATIONS",
    "true",
).lower() in {"1", "true", "yes"}
BACKGROUND_JOB_SYNC_NOTIFICATIONS = os.environ.get(
    "BACKGROUND_JOB_SYNC_NOTIFICATIONS",
    "false",
).lower() in {"1", "true", "yes"}
