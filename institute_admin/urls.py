...
urlpatterns = [
    ...
    path("reports/student-admissions/", views.student_admission_report, name="student_admission_report"),
    path("reports/inactive-students/", views.inactive_students_report, name="inactive_students_report"),
    path("visitors/", views.visitor_list, name="visitor_list"),
    path("visitors/export/", views.visitor_export, name="visitor_export"),
    ...
    path("students/create-dummy/", views.student_dummy_create, name="student_dummy_create"),
    path("students/<int:pk>/", views.student_dashboard, name="student_dashboard"),
    path("students/<int:pk>/admission-form/", views.student_admission_form, name="student_admission_form"),
    path("students/<int:pk>/tc/generate/", views.student_tc_generate, name="student_tc_generate"),
    path("students/<int:pk>/bonafide/generate/", views.student_bonafide_update, name="student_bonafide_generate"),
    path("students/<int:pk>/bonafide/update/", views.student_bonafide_update, name="student_bonafide_update"),
    path("students/<int:pk>/id-card/update/", views.student_id_card_update, name="student_id_card_update"),
    ...
    path("students/<int:pk>/delete-details/", views.student_delete_details, name="student_delete_details"),
    path("students/<int:pk>/delete/", views.student_delete, name="student_delete"),
    path("student-documents/<int:pk>/delete/", views.student_document_delete, name="student_document_delete"),
    path("student-tc/<int:pk>/print/", views.student_tc_print, name="student_tc_print"),
    path("student-tc/<int:pk>/cancel/", views.student_tc_cancel, name="student_tc_cancel"),
    path("student-bonafide/<int:pk>/print/", views.student_bonafide_print, name="student_bonafide_print"),
    path("student-bonafide/<int:pk>/cancel/", views.student_bonafide_cancel, name="student_bonafide_cancel"),
    ...
    path("results/export/", views.results_export, name="institute_results_export"),
]
